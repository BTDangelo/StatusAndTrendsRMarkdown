...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Curry County AgWQ
  Management Area'
author: ''
date: "May 2018"
output:
...
input$select <- "Curry County" #input
input$dates <- c("2000-01-01", "2018-06-01") #input
...
if(input$select == 'Curry County') {
  load("//deqhq1/TMDL/AgWQM/DataAnalysis/Curry County/2018/Curry_County_2018-05-08.Rdata")
} else {
...
#save(df.all, file = "//deqhq1/tmdl/AgWQM/DataAnalysis/Curry County/2018/Curry_County_2018-05-08.Rdata")

#load(file = "//deqhq1/tmdl/AgWQM/DataAnalysis/Curry County/2018/Curry_County_2018-05-08.Rdata")
...
write.csv(stns, "E:/GitHub/StatusAndTrendsRMarkdown/Lookups/stations_Curry_County.csv")
